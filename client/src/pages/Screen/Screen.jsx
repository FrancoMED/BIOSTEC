	...
	return (
        <div class="lp-wrapper">
			...
			<section class="lp-hero">
				<div class="lp-urgency-badge">⚡ Resposta em menos de 5 minutos</div>

				<h1>Tela quebrada? <span>Orçamento GRÁTIS</span> pelo WhatsApp</h1>

				<p class="lp-hero-subtitle">
					Descubra se precisa trocar a tela ou se tem conserto mais barato — sem
					sair de casa.
				</p>

				{/* <!-- Proceso en 3 pasos --> */}
				<div class="lp-steps">
					<span class="lp-step">📸 Envie foto</span>
					<span class="lp-step-arrow">→</span>
					<span class="lp-step">🔍 Técnico analisa</span>
					<span class="lp-step-arrow">→</span>
					<span class="lp-step">💰 Receba orçamento</span>
				</div>
				...
				<a
					...
					rel="noreferrer"
				>
					📱 Enviar foto agora (é grátis)
				</a>

				<p class="lp-hero-trust">
					🛡️ 20 anos de experiência <span>·</span> Garantia de 1 ano
					<span>·</span> Peças originais
				</p>

				{/* <!-- Prueba Social --> */}
				<div class="lp-social-proof">
					<div class="lp-proof-item">
						<div class="lp-proof-number">+15000</div>
						<div class="lp-proof-label">equipamentos reparados</div>
					</div>
					<div class="lp-proof-item">
						<div class="lp-proof-number">20</div>
						<div class="lp-proof-label">anos experiência</div>
					</div>
					<div class="lp-proof-item">
						<div class="lp-proof-number">⭐ 4.9</div>
						<div class="lp-proof-label">no Google</div>
					</div>
				</div>
			</section>
